...
\title{\LARGE \bf
Report from the research of the article Saluki: Finding Taint-style Vulnerabilities with
Static Property Checking
}

%\author{ \parbox{3 in}{\centering Jacek Janczura*
...
\author{Jacek Janczura$^{1}$% <-this % stops a space
\thanks{$^{1}$J. Janczura; Computer Science,
        Technische Universität Berlin, Hardenbergstraße 19, 10623 Berlin
        {\tt\small janczura.jacek@gmail.com}}%
}
